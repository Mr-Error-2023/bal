...
def update():
    ...
    if (toolVersion != mainVersion):
        ...
        os.system("cd .. && cd bal && python bal.py")
...
def logo():
    ...
    print("\033[94m│  \033[95mAuthor : Mr. Error                       \033[94m│".center(columns+15))
    print(" │  \033[95mTool   : Unlimited SMS Bomber            \033[94m│".center(columns+9))
    print("  │  \033[95mGitHub : https://github.com/Mr-Error-2023\033[94m│".center(columns+9))
    print("│  \033[95mCoder  : Mr-Error-2023             \033[37mV 0.1 \033[94m│".center(columns+15))
    print("\033[94m└───────────────────────────────────────────┘".center(columns+5))
